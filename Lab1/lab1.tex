...
File > New Project Wizard %Figure
...
File > Save As > \emph{lab1.vhd} > SAVE
...
Assignments > Import Assignments >  Select \emph{... .qsf} %figure
ADVANCED > Check Global Assignments > Ok %Figure
